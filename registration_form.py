...
def form():
    ...
    # Defining function for inserting value in database, showing info and destroying registration windows
    def signup():
    ...
    signup_label = Label(register_win, text="Let's Start", fg="#785dae", bg="#bfb5f4", font=("Ariel", 20, "bold"),
                         width=15)
    signup_label.place(x=870, y=140)
    signup_name = Label(register_win, text="Hurry up! and Sign up", fg="#785dae", bg="#bfb5f4",
                        font=("Ariel", 20, "bold italic"))
    signup_name.place(x=860, y=100)

    # Inserting Label (Name,password ,Phone Number) and Entry Widget
    first_name = Label(register_win, text="First Name: ", width=10, font=("Ariel", 13, "bold"), fg="#fbfbfd",
                       bg="#bfb5f4")
    ...
    last_name = Label(register_win, text="Last Name: ", width=10, font=("Ariel", 13, "bold"), fg="#fbfbfd",
                      bg="#bfb5f4")
    ...
    new_password = Label(register_win, text="New Password: ", width=12, font=("Ariel", 13, "bold"), fg="#fbfbfd",
                         bg="#bfb5f4")
    new_password.place(x=762, y=340)
    new_password_input = Entry(register_win, width=25, font=("Ariel", 11), show="*", relief=GROOVE, bg="#f7f7f7",
                               fg="black")
    new_password_input.place(x=760, y=370, height=25)
    postal_code = Label(register_win, text="Postal Code: ", width=12, font=("Ariel", 13, "bold"), fg="#fbfbfd",
                        bg="#bfb5f4")
    postal_code.place(x=981, y=340)
    postal_code_input = Entry(register_win, width=25, font=("Ariel", 11), relief=GROOVE, bg="#f7f7f7", fg="black")
    postal_code_input.place(x=990, y=370, height=25)
    address_name = Label(register_win, text="Address: ", width=8, font=("Ariel", 13, "bold"), fg="#fbfbfd",
                         bg="#bfb5f4")
    ...
    contact_no = Label(register_win, text="Contact No: ", width=12, font=("Ariel", 13, "bold"), fg="#fbfbfd",
                       bg="#bfb5f4")
    ...
    # Inserting check box
    check_terms = Checkbutton(register_win, font=("Ariel", 12, "bold"), activebackground="#bfb5f4",
                              activeforeground="black", fg="black", bg="#bfb5f4",
                              text="I agree the Terms and Conditions and Privacy Policy.", onvalue="ON", offvalue="OFF")
    check_terms.deselect()
    check_terms.place(x=760, y=480, height=35)

    btn_signup = Button(register_win, command=signup, text="Sign Up", width=15, relief=RAISED, bg="#785dae",
                        fg="#fafafc", activebackground="#785dae", activeforeground="#fafafc",
